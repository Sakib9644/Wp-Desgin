...
@section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                   ...
                   @endif
                    ...
                    <!-- Right: DataTable -->
                    <div class="{{auth()->user()->HasRole('Super Admin') ? 'col-md-9': 'col-md-12' }}">
                        <div class="card">
                            <div class="card-body">
    ...
    <script>
        $(document).on('change', '.status-toggle', function() {
            ...
            $.ajax({
                url: '{{ route('user.status','userId') }}'.replace('userId',userId),
                type: 'GET',
        ...
        $(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $.ajax({
                    url: '/users/' + userId +
                    '/edit', // You need to define this route in your web.php
                    method: 'GET',
                    success: function(data) {
                        ...
                        userId); // Direct route for update
